...
class Type
{
    ...
    public function __construct()
    {
        ...
        //
        $this->output = $this->Path->clear_path()."FILES".DIRECTORY_SEPARATOR."types".DIRECTORY_SEPARATOR;
    }
    ...
    public function add($array)
    {
        ...
        if(!is_numeric($cat_id)){
            throw new \Exception("Не верный параметр cat_id");}
...
//           "logo" => $filename
        ...
        $resAdd = $this->DB->insert("types", $arr);
...
//           "logo" => $filename
        ...
        $resDB = $this->DB->update("types", $arr, "ID = ".$id);
        return $resDB;
    ...
    public function get_few($settings)
    {
        ...
        $sql = "SELECT COUNT(*) AS n FROM types WHERE cat_id=".$cat_id;
        ...
        $sql = "SELECT * FROM types WHERE cat_id=".$cat_id." ORDER BY nomer ASC LIMIT ".$resNav["start"].",".$resNav["limit"];
