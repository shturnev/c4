...
class Category
{
    ...
    public function __construct()
    {
        ...
        //
        $this->output = $this->Path->clear_path()."FILES".DIRECTORY_SEPARATOR."categories".DIRECTORY_SEPARATOR;
    }
...
//           "logo" => $filename
    ...
    public function get_few($settings)
    {
        ...
        $sql = "SELECT * FROM categories ORDER BY nomer ASC LIMIT ".$resNav["start"].",".$resNav["limit"];
