...
Собирем товары
-----------------------------------*/
$arr = ["limit" => 30, "page" => @$_GET["page"], "order_by_col" => "ID", "order_by_type" => "DESC", "bound_type" => @$_GET["bound_type"], "bound_id" => @$_GET["bound_id"],];
$products = $P->get_few($arr);
    ...
    <div class="container">
        <div class="col-md-9">
            <div class="mid-popular">
                <? if($products["items"]): foreach ($products["items"] as $item){   ?>
                    <div class="col-md-4 item-grid1 simpleCart_shelfItem">
                    <div class=" mid-pop">
                        <div class="pro-img">
                            <img src="/e-shop/FILES/gallery/small/<? echo $item["photo"] ?>" class="img-responsive" alt="">
                            <div class="zoom-icon ">
                                <a class="picture" href="/e-shop/FILES/gallery/big/<? echo $item["photo"] ?>" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="mid-2">
                                <p><!--<label>$</label>--><em class="item_price">$<? echo $item["price"] ?></em></p>
                                <div class="block">
        ...
        <div class="col-md-3 product-bottom">
            ...
            <div class=" rsidebar span_1_of_left">
                ...
                <ul class="menu-drop">
                    <li class="item1">
                        ...
                        <ul class="cute">
                            <li class="subitem1">
                                <a href="product.php">Cute Kittens</a>
                            </li>
                            <li class="subitem2">
                                <a href="product.php">Strange Stuff</a>
                            </li>
                            <li class="subitem3">
                                <a href="product.php">Automatic Fails</a>
                            </li>
                        </ul>
                    </li>
                    <li class="item2">
            ...
            <section class="sky-form">
                ...
                <div class="row row1 scroll-pane">
                    <div class="col col-4">
                        <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i></i>Sofa Cum Beds
                            (30)</label>
                    </div>
                    <div class="col col-4">
